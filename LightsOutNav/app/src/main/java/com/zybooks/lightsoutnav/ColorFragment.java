...
public class ColorFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        int colorId = sharedPref.getInt("color", R.color.cyan);

        // Select the radio button matching the color ID
        int radioId = R.id.radio_cyan;
        ...
        else if (colorId == R.color.cyan) {
            radioId = R.id.radio_cyan;
        }
    ...
    private void onColorSelected(View view) {
        ...
        else if (view.getId() == R.id.radio_cyan) {
